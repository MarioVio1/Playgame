        ...
        if (!cpu.finished) {
          ...
          const wordLists: Record<string, Record<string, string[]>> = {
            'A': {
              ...
              'Città': ['Ancona', 'Aosta', 'Avellino', 'Asti', 'Agrigento', 'Arezzo', 'Ascoli'],
              'Animale': ['Aquila', 'Asino', 'Anatra', 'Ape', 'Ariete', 'Alce', 'Anemone'],
              'Frutto': ['Arancia', 'Anguria', 'Albicocca', 'Ananas', 'Aronia', 'Avocado'],
              'Lavoro': ['Avvocato', 'Architetto', 'Attore', 'Agricoltore', 'Allevatore'],
              'Fiore': ['Anemone', 'Aster', 'Azalea', 'Agrifoglio', 'Amarillide'],
            },
            'B': {
              'Nome': ['Bianca', 'Bruno', 'Barbara', 'Benedetta', 'Beatrice', 'Beppe', 'Bettino'],
              'Città': ['Bari', 'Bergamo', 'Bologna', 'Brescia', 'Bolzano', 'Benevento', 'Brindisi'],
              'Animale': ['Bue', 'Bisonte', 'Babirussa', 'Basilisco', 'Barbagianni'],
              'Frutto': ['Banana', 'Bacca', 'Bergamotto'],
              'Lavoro': ['Bancario', 'Barista', 'Ballerino', 'Biologo', 'Bibliotecario'],
              'Fiore': ['Bromelia', 'Bougainvillea', 'Begonia', 'Biancospino'],
            },
            'C': {
              ...
              'Animale': ['Cavallo', 'Cane', 'Cervo', 'Coccodrillo', 'Capra', 'Cinghiale'],
              'Frutto': ['Ciliegia', 'Caco', 'Clementina'],
              'Lavoro': ['Cuoco', 'Cameriere', 'Contadino', 'Carpentiere', 'Commercialista'],
              'Fiore': ['Crisantemo', 'Ciclamino', 'Camelia', 'Crocus', 'Calla'],
            },
            'D': {
              'Nome': ['Daniele', 'Davide', 'Diana', 'Domenico', 'Donato', 'Dario', 'Dora', 'Damiano'],
              'Città': ['Domodossola', 'Dongo', 'Diamante', 'Dresda'],
              'Animale': ['Delfino', 'Daino', 'Dingo', 'Dromedario'],
              'Frutto': ['Dattero', 'Durian', 'Duku'],
              'Lavoro': ['Dottore', 'Dentista', 'Designer', 'Direttore', 'Docente'],
              'Fiore': ['Dalia', 'Dente di leone', 'Dicentra', 'Drimiopsis'],
            },
            'E': {
              ...
              'Frutto': ['Eucalyptus'],
              'Lavoro': ['Elettricista', 'Elettrotecnico', 'Economista', 'Estetista'],
              'Fiore': ['Edelweiss', 'Eustoma', 'Erica', 'Elleboro'],
            },
            'F': {
              'Nome': ['Francesco', 'Federico', 'Federica', 'Flavio', 'Fabio', 'Fiorella', 'Filippo'],
              'Città': ['Firenze', 'Ferrara', 'Foggia', 'Forlì', 'Fermo', 'Fidenza', 'Fabriano'],
              'Animale': ['Farfalla', 'Foca', 'Fagiano', 'Furetto', 'Formica'],
              'Frutto': ['Fragola', 'Fico', 'Feijoa'],
              'Lavoro': ['Fotografo', 'Fioraio', 'Fisioterapista', 'Farmacia', 'Fabbro'],
              'Fiore': ['Freesia', 'Fucsia', 'Fiordaliso', 'Fresia', 'Frassino'],
            },
            'G': {
              'Nome': ['Giuseppe', 'Giovanni', 'Giulia', 'Giorgia', 'Gabriele', 'Giacomo', 'Ginevra', 'Gaetano'],
              'Città': ['Genova', 'Gorizia', 'Grosseto', 'Gubbio', 'Gallipoli'],
              'Animale': ['Gatto', 'Giraffa', 'Gallo', 'Gorilla', 'Ghepardo', 'Gabbiano'],
              'Frutto': ['Guava', 'Gelso', 'Grosella'],
              'Lavoro': ['Geologo', 'Giardiniere', 'Grafico', 'Guidatore', 'Giornalista'],
              'Fiore': ['Garofano', 'Gelsomino', 'Giacinto', 'Giglio', 'Gloxinia'],
            },
            'I': {
              'Nome': ['Ivano', 'Ivana', 'Ivan', 'Ilaria', 'Italo', 'Ida', 'Ignazio', 'Irene'],
              'Città': ['Imperia', 'Isernia', 'Ivrea'],
              'Animale': ['Iena', 'Iguana', 'Ippopotamo'],
              'Frutto': ['Incircetta'],
              'Lavoro': ['Impiegato', 'Ingegnere', 'Infermiera', 'Insegnante', 'Illustratore'],
              'Fiore': ['Ibisco', 'Iris', 'Iperico'],
            },
            'L': {
              'Nome': ['Luca', 'Laura', 'Lorenzo', 'Lucia', 'Luigi', 'Luisa', 'Leonardo', 'Livia'],
              'Città': ['Lucca', 'Livorno', 'Lecce', 'Lodi', 'Latina', 'Lecco', 'Lamezia'],
              'Animale': ['Leone', 'Lupo', 'Lepre', 'Lontra', 'Lince', 'Lama'],
              'Frutto': ['Limone', 'Litchi', 'Lampone', 'Lime'],
              'Lavoro': ['Lavavetri', 'Legale', 'Linguista', 'Lavoratore', 'Libraio'],
              'Fiore': ['Lavanda', 'Lillà', 'Loto', 'Liriope', 'Lobelia'],
            },
            'M': {
              'Nome': ['Marco', 'Maria', 'Matteo', 'Martina', 'Michele', 'Monica', 'Mario', 'Marta'],
              'Città': ['Milano', 'Messina', 'Mantova', 'Modena', 'Matera', 'Monza', 'Massa'],
              'Animale': ['Maiale', 'Mucca', 'Mosca', 'Mammuth', 'Marasso'],
              'Frutto': ['Mela', 'Mandarino', 'Melone', 'Mirtillo', 'Mora', 'Mango', 'Maracuja'],
              'Lavoro': ['Meccanico', 'Medico', 'Muratore', 'Manager', 'Musicista'],
              'Fiore': ['Margherita', 'Mimosa', 'Mughetto', 'Magnolia', 'Maltese'],
            },
            'N': {
              'Nome': ['Nicola', 'Nadia', 'Nino', 'Nicoletta', 'Natalia', 'Napoleone', 'Nora'],
              'Città': ['Napoli', 'Novara', 'Nuoro', 'Nola', 'Nocera', 'Narni'],
              'Animale': ['Narvalo', 'Nutria'],
              'Frutto': ['Noce', 'Nespola'],
              'Lavoro': ['Notaio', 'Nutrizionista', 'Nefrologo', 'Naturopata'],
              'Fiore': ['Narciso', 'Ninfea', 'Nontiscordardime'],
            },
            'O': {
              'Nome': ['Oscar', 'Olga', 'Omar', 'Ornella', 'Oreste', 'Ottavia', 'Osvaldo'],
              'Città': ['Olbia', 'Oristano', 'Orvieto', 'Ostia', 'Oderzo'],
              'Animale': ['Orso', 'Oca', 'Orata', 'Opossum', 'Orangutan'],
              'Frutto': ['Oliva'],
              'Lavoro': ['Oculista', 'Ospite', 'Operatore', 'Osteopata'],
              'Fiore': ['Orchidea', 'Oleandro', 'Osmanthus'],
            },
            'P': {
              'Nome': ['Paolo', 'Pietro', 'Patrizia', 'Pierluigi', 'Piera', 'Palmiro', 'Pio'],
              ...
              'Lavoro': ['Pilota', 'Parrucchiere', 'Pittore', 'Pasticcere', 'Postino'],
              'Fiore': ['Petunia', 'Primula', 'Peonia', 'Papavero', 'Passiflora'],
            },
            'R': {
              'Nome': ['Roberto', 'Rosa', 'Riccardo', 'Raffaella', 'Romeo', 'Rita', 'Ruggero', 'Rina'],
              'Città': ['Roma', 'Ravenna', 'Reggio', 'Rieti', 'Rovigo', 'Ragusa', 'Rimini'],
              'Animale': ['Rana', 'Riccio', 'Rondine', 'Rospo', 'Renna'],
              'Frutto': ['Rabarbaro', 'Rambutan', 'Ribes'],
            ...
            'S': {
              ...
              'Lavoro': ['Scalatore', 'Scultore', 'Scienziato', 'Sceneggiatore', 'Sartoria'],
              'Fiore': ['Stella di Natale', 'Salvia', 'Strelitzia', 'Stefania'],
            },
            'T': {
              ...
              'Frutto': ['Tamarindo', 'Tomatillo'],
              'Lavoro': ['Tassista', 'Tatuaggio', 'Tecnico', 'Trombettista', 'Tutor'],
              'Fiore': ['Tulipano', 'Tiglio', 'Tritoma', 'Torenia'],
            },
            'U': {
              'Nome': ['Umberto', 'Ugo', 'Ubaldo', 'Ursula', 'Uliviero'],
              'Città': ['Udine', 'Urbino', 'Ugento', 'Uggiate'],
              'Animale': ['Upupa', 'Uccello'],
              'Frutto': ['Uva'],
              'Lavoro': ['Unicorno', 'Uomo', 'Ufficiale'],
              'Fiore': ['Ursinia'],
            },
            'V': {
              'Nome': ['Vincenzo', 'Valentina', 'Vittorio', 'Veronica', 'Vittoria', 'Vladimiro', 'Vera', 'Valerio'],
              'Città': ['Venezia', 'Verona', 'Vicenza', 'Viterbo', 'Varese', 'Vibo', 'Vercelli'],
              'Animale': ['Volpe', 'Vipera', 'Vampiro'],
              'Frutto': ['Vaniglia', 'Vite'],
              'Lavoro': ['Veterinario', 'Vigile', 'VideoMaker', 'Virologo', 'Velaio'],
              'Fiore': ['Viola', 'Viburno', 'Veltheimia', 'Vinca'],
            },
            'Z': {
              'Nome': ['Zaccaria', 'Zoe', 'Zenone', 'Zaira', 'Zelinda'],
              'Città': ['Zara', 'Zavattarello', 'Zogno'],
              'Animale': ['Zebra', 'Zanzara'],
              'Frutto': ['Zucca', 'Zenzero'],
              'Lavoro': ['Zoologo', 'Zucchiere', 'Zampognaro'],
              'Fiore': ['Zinnia', 'Zantedeschia', 'Zafferano'],
            },
          };
          ...
          const defaultWords: Record<string, string[]> = {
            ...
            'Lavoro': ['Lavoro1', 'Lavoro2', 'Lavoro3'],
            'Fiore': ['Fiore1', 'Fiore2', 'Fiore3'],
          };
